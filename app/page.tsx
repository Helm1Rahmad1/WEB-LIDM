...
export default function HomePage() {
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-[#D5DBDB]/80 via-[#D5DBDB]/80 to-[#c8d0d0]/80 z-0"></div>
        ...
        <section className="relative z-10 py-24 px-6">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm rounded-full px-6 py-3 mb-8 shadow-lg border border-white/20">
              ...
              <span className="font-semibold text-[#2C3E50]">tes Platform Pembelajaran Visual</span>
